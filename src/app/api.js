...
function fetchPokemonById(id) {
    return __awaiter(this, void 0, void 0, function () {
        var response, data, pokemon, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    response = _a.sent();
                    if (!response.ok) {
                        throw new Error("Pokemon number: ".concat(id, " not found!"));
                    }
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error('Error fetching Pokemon: ', error_1);
                    throw error_1;
...
function searchPokemonByName(name) {
    return __awaiter(this, void 0, void 0, function () {
        var response, data, pokemon, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch("https://pokeapi.co/api/v2/pokemon/".concat(name.toLowerCase()))];
                case 1:
                    response = _a.sent();
                    if (!response.ok) {
                        throw new Error("Pokemon ".concat(name.toLowerCase(), " not found!"));
                    }
                    return [4 /*yield*/, response.json()];
                case 2:
                    data = _a.sent();
                ...
                case 3:
                    error_2 = _a.sent();
                    console.error('Error fetching Pokemon: ', error_2);
                    throw error_2;
                case 4: return [2 /*return*/];
            }
        });
